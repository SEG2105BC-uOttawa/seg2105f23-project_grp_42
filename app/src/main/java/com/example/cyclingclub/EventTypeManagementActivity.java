...
public class EventTypeManagementActivity extends AppCompatActivity {
    ...
    public void onClickAddEventType(View view) {
        ...
        View dialogView = getLayoutInflater().inflate(R.layout.update_event_type_dialog, null);
        dialogBuilder.setView(dialogView);

        EditText editTextName = dialogView.findViewById(R.id.editTextTypeName);
    ...
    public void onClickAddEvent(View view) {
        ...
        AlertDialog.Builder dialogBuilder = createDialogBuilder(R.layout.update_event_type_dialog);
        View dialogView = inflateView(R.layout.event_detail);
    ...
    private Map<String, View> setupDialogView(View dialogView, AlertDialog.Builder dialogBuilder, User user) {
        ...
        views.put("editTextName", dialogView.findViewById(R.id.editTextTypeName));
        views.put("editTextDetail", dialogView.findViewById(R.id.editTextDescription));
        views.put("buttonUpdate", dialogView.findViewById(R.id.buttonUpdate));
        views.put("buttonDelete", dialogView.findViewById(R.id.buttonDelete));
        views.put("editEventId", dialogView.findViewById(R.id.editEventId));
        views.put("editEventType", dialogView.findViewById(R.id.editEventType));
        views.put("editEventRegion", dialogView.findViewById(R.id.editEventRegion));
        views.put("editEventDate", dialogView.findViewById(R.id.editEventDate));
        views.put("editEventRoute", dialogView.findViewById(R.id.editEventRoute));
        views.put("editEventDistance", dialogView.findViewById(R.id.editEventDistance));
        views.put("editEventElevation", dialogView.findViewById(R.id.editEventElevation));
        views.put("spinnerLevel", dialogView.findViewById(R.id.spinnerLevel));
        views.put("editEventFee", dialogView.findViewById(R.id.editEventFee));
