...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.cyclingclub.R.layout.activity_signup);

        // Initialize UI elements
        cyclingClubRadio = findViewById(com.example.cyclingclub.R.id.cyclingClubRole);
        participantRadio = findViewById(com.example.cyclingclub.R.id.participantRole);
        firebaseAuth = FirebaseAuth.getInstance();

        Button signupButton = findViewById(com.example.cyclingclub.R.id.btnDeleteUser);

        signupButton.setOnClickListener(view -> {
            // Get the values from the input fields
            EditText emailEditText = findViewById(com.example.cyclingclub.R.id.emailTextField);
            EditText usernameEditText = findViewById(com.example.cyclingclub.R.id.usernameTextField);
                        ...
                        .addOnCompleteListener(this, task -> {
                            if (task.isSuccessful()) {
                                ...
                                if (firebaseUser != null) {
                                    ...
                                    /* Redirect to the WelcomeScreenActivity after creation */
