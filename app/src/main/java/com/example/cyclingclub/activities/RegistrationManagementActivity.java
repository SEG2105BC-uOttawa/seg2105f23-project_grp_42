...
/**
 * The RegistrationManagementActivity class is an activity that manages registrations.
...
public class RegistrationManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegistrationAdapter regAdapter = new RegistrationAdapter(RegistrationManagementActivity.this, registrations);
