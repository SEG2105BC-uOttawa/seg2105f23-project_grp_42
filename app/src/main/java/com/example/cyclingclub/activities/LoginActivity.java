...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.cyclingclub.R.layout.activity_login);

        firebaseAuth = FirebaseAuth.getInstance();

        final EditText usernameEditText = findViewById(com.example.cyclingclub.R.id.usernameTextField);
        final EditText passwordEditText = findViewById(com.example.cyclingclub.R.id.passwordTextField);
