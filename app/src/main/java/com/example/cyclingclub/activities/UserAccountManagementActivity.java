...
import com.example.cyclingclub.fragments.UserListFragment;
...
/**
 * The UserAccountManagementActivity class is an activity that manages user accounts.
...
public class UserAccountManagementActivity extends AppCompatActivity {
    ...
    public UserAccountManagementActivity() { }
